      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="mb-8 flex items-center justify-between">
          <div>
            ...
            <p className="mt-2 text-gray-400">Dispositivos e serviços</p>
          </div>
          <button
            disabled
        ...
        <div className="rounded-xl border border-jarvis-navy bg-jarvis-dark/30 p-12 text-center">
          <Link2 className="mx-auto mb-4 h-12 w-12 text-gray-600" />
          <p className="text-lg text-gray-400">
            Nenhuma integração conectada
          </p>
          <p className="mt-2 text-sm text-gray-600">
            Conecte dispositivos MQTT, Docker e notificações nas próximas ondas.
          </p>
        </div>
      </div>
    </main>
